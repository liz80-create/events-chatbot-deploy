# /api/index.py
#
# Your original FastAPI code, fully restored and adapted with the
# definitive Vercel compatibility fixes.
...
# --- Your Application Code (Restored) ---
...
# --- API Routes ---
# The paths are relative to /api/ because the file is /api/index.py
@app.post("/query")
