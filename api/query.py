# /api/query.py
#
# Final, complete, framework-less Vercel handler. This directly maps
# the file path /api/query.py to the API route /api/query, removing
# all framework and routing conflicts.
...
# --- Final Configuration and Initialization ---

logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
logger = logging.getLogger(__name__)

# This custom class fixes the 'datetime is not JSON serializable' error.
...
# --- Initialize Services ONCE for reuse across invocations ---
try:
    config = Config()
...
# This class is the entry point for all requests to /api/query
